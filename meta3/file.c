...
lista criar_tabela(no1 r){
    lista tab;
    tab.inicio = NULL; 
    no1 raiz_aux = r->filho->irmao;
...
void metodo_header(metodo *tabela, no1 r2){    
    no1 r = r2->filho->irmao->irmao->filho->filho;
    char *c = type(r->tipo);
    int count = 0;
    ...
    count++;
    no1 r1 = r2->filho->irmao->irmao->filho->irmao;
...
void metodo_body(metodo *tabela, no1 r3){
    no1 r4 = r3->filho;
